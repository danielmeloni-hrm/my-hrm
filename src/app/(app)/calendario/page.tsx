...
import AppCalendarPage from '@/components/ui/AppCalendarPage'
...
const GOOGLE_CALENDARS = [
  {
    ...
    dot: 'bg-amber-500',
    calendarId:
      '66d24b1d19fd7adedefabcae03dddafa97bee68e68cb46e2ecc8dbc9d10bdbaf@group.calendar.google.com'
  },
  {
    id: 'webanalytics',
    ...
    dot: 'bg-emerald-500',
    calendarId:
      '926d04a992e7d85fe3f8a14ab3d63e7e760c63e8233a221e59a429295ba9aedc@group.calendar.google.com'
  },
  {
    id: 'prod',
    ...
    dot: 'bg-rose-500',
    calendarId:
      '732eacb1f9fc6f955a9f912ef7a4c840e72bc1214c4583ff9cee9a3879d4d3d9@group.calendar.google.com'
  },
  {
    id: 'collaudo',
    ...
    dot: 'bg-violet-500',
    calendarId:
      'e1b8680caf760dcc73c31959828d8525072c9432f6bc0be0b12f484c1265a2eb@group.calendar.google.com'
  }
]
...
export default function ReleaseCalendar() {
  ...
  const getReleasesForDate = useCallback(
    (d: Date) => {
  ...
  const getTimedEventsForDate = useCallback(
    (d: Date) => {
  ...
  const getAllDayGoogleEventsForDate = useCallback(
    (d: Date) => {
  ...
  const onDragEnd = async (result: any) => {
    ...
    setTickets(prev =>
      prev.map(t =>
        String(t.id) === String(ticketId) ? { ...t, [column]: newDateStr } : t
      )
    )
  ...
  return (
    <AppCalendarPage
      ...
      subtitle={currentDate.toLocaleDateString('it-IT', {
        month: 'long',
        year: 'numeric'
      })}
      actions={
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={() => navigate(-1)}
            className="p-3 bg-white border border-gray-100 rounded-2xl hover:bg-gray-50 shadow-sm"
          >
            <ChevronLeft size={18} />
          </button>
    ...
    >
      <DragDropContext onDragEnd={onDragEnd}>
        {viewMode === 'week' ? (
                                ...
                                <div className="flex items-center gap-1.5">
                                  <span
                                    className={`w-2 h-2 rounded-full ${
                                      rel.type === 'PROD' ? 'bg-rose-500' : 'bg-violet-500'
                                    }`}
                                  />
                        ...
                        >
                          <div className="flex items-center justify-between gap-2 mb-1">
                            <div className="flex items-center gap-1.5 min-w-0">
                              <span
                                className={`w-2 h-2 rounded-full flex-shrink-0 ${event.calendarDot}`}
                              />
          ...
          <div className="h-full overflow-auto p-4 bg-[#FBFBFB]">
                      ...
                      <div
                        ...
                        className={`min-h-[240px] p-4 rounded-[2.5rem] border transition-all cursor-pointer ${
                          snapshot.isDraggingOver
                            ? 'bg-blue-50/50 border-blue-300 scale-[1.02]'
                            : isToday
                              ? 'bg-blue-50/40 border-blue-200'
                              : 'bg-white border-gray-100 hover:border-gray-300'
                        } ${
                          !isCurrentMonth
                            ? 'opacity-30 grayscale-[0.8] bg-gray-50/50'
                            : 'opacity-100'
                        }`}
                      >
                            ...
                            <Draggable key={rel.dndId} draggableId={rel.dndId} index={rIdx}>
                              {p => (
                                ...
                                >
                                  ...
                                  <h5 className="text-[11px] font-black uppercase line-clamp-1">
                                    #{rel.n_tag}
                                  </h5>

                                  <span className="text-[9px] font-bold line-clamp-1 italic opacity-80">
                                    {rel.titolo}
                                  </span>
                                </div>
                              )}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
          ...
          <div className="relative bg-white border border-gray-100 rounded-[3rem] p-8 shadow-2xl w-full max-w-xl max-h-[90vh] flex flex-col">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-3xl font-black italic uppercase leading-none text-black">
                  Dettaglio
                </h3>
