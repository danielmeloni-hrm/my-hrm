...
function Card({
  ...
  return (
    <div
      className={cn(
        "rounded-[28px] border border-slate-100 bg-white shadow-sm overflow-hidden",
        className
      )}
    >
...
function TicketSquare({
  ...
  const palette = {
    ...
    purple:
      "bg-purple-500 border-purple-200 text-purple-700 hover:bg-purple-50",
  }[color];
      ...
      <div className="w-full">
        ...
        {success && (
          <div className="mb-8 p-4 rounded-2xl bg-green-50 border border-green-200 text-green-600 text-xs font-bold">
            ✅ {createdTicketId ? "Ticket creato" : "Evento creato"}
          </div>
        )}
          ...
          <div className="lg:col-span-8 space-y-8">
            {isTaskMode ? (
              <Card
                ...
                subtitle="Informazioni base del ticket"
              >
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        >
          {creatingCliente ? "Salvataggio..." : "Aggiungi"}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Field label="N° INC Padre" hint="Numero principale">
                          <input
                            type="text"
                            value={aForm.n_tag}
                            placeholder="Inserisci ID Incident"
                            onChange={(e) =>
                              setAForm((p) => ({ ...p, n_tag: e.target.value }))
                            }
                  ...
                  {/* Attività: N° TAG e link standard */}
                  {mode !== "incident" && (
                    <>
                      <Field label="N° TAG" hint="ID Ticket">
                        <input
                          type="text"
                          value={aForm.n_tag}
                          placeholder={suggestedTag || "Inserisci ID ticket"}
                          onChange={(e) =>
                            setAForm((p) => ({ ...p, n_tag: e.target.value }))
                          }
                      ...
                      <Field label="Link TAG SN" hint="URL Ticket">
                        <input
                          type="text"
                          value={aForm.link_tag}
                          onChange={(e) =>
